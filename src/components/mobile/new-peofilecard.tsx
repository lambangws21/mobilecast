  ...
  return (
    <div className="mx-auto w-full max-w-[500px] pb-[50px] my-[100px]">
      ...
      >
        ...
        />
        <motion.div
          className="w-[300px] h-[430px] flex flex-col justify-center items-center rounded-[20px] bg-[#f5f5f5] shadow-xl origin-[10%_60%] p-5 text-center"
          variants={cardVariants}
        >
            <h1 className="font-semibold mb-2 -mt-7">My Profile</h1>
          <Image src={ENT1} width={90} height={50} alt="lambang" className="rounded-lg border-4 bg-green-200 shadow-xl"/>
          <h1 className="font-semibold uppercase text-3xl mt-2">Herlambang W</h1>
...
const splashBackground = `linear-gradient(306deg, #ffff00, #008800)`;
